...
fname_gals = "/project/rrg-wperciva/tsfraser/LRGMocks/CutSky/LRG/z0.800/MOD_frac__caty5sv3_cutsky_LRG_z0.800_AbacusSummit_base_c000_ph000.fits"
fname_randoms = "/project/rrg-wperciva/tsfraser/Revolver/rands_nz10_sv3y5_LRG_prefiltered.fits"


zobovfname = '/project/rrg-wperciva/tsfraser/LRGVoids/CutSky/stacked_run2_lrgy5sv3zobov-Voids_cat.txt'
...
res_zob =TwoPointCorrelationFunction('s',edges,data_positions1 = gal_positions , \
    data_weights1 = gal_weights, data_positions2 = zob_positions, data_weights2 = zob_weights,\
         randoms_position1 = rand_positions,randoms_weights1 =rand_weights,engine='corrfunc',nthreads =56) 
end = time.time()
