...
nthreads = 16     # set to the number of CPUs available, more is better
# ================================ #

# ========= file handling options ========= #
handle = 'default'  # string to identify the run; used to set filenames
output_folder = '/project/rrg-wperciva/tsfraser/ELGvoids/'   # /path/to/folder/ where output should be placed
# ========================================= #

# ========== cosmology ============ #
omega_m = 0.315  # used for reconstruction and to convert redshifts to distances (assumes flat Universe!)
# ================================= #
...
f = 0.807        # the linear growth rate at the mean redshift
...
tracer_file = '/project/rrg-wperciva/tsfraser/ELGMocks/CutSky/ELG/z1.100/cutsky_ELG_z1.100_AbacusSummit_base_c000_ph000.fits'     # /path/to/file with input data
...
box_length = 2000.   # if is_box, the box side length in Mpc/h; else ignored
...
z_low_cut = 0.8      # lower redshift cut (ignored if not survey)
z_high_cut = 1.4    # higher redshift cut (ignored if not survey)
...
random_file = '/project/rrg-wperciva/tsfraser/ELGMocks/CutSky/ELG/z1.100/cutsky_ELG_random_S1000_1X.fits'   # /path/to/file containing randoms data
...
z_min = 0.8        # minimum redshift extent of the data
z_max = 1.4        # maximum redshift extent of the data
...
use_z_wts = False     # set True if survey n(z) is not uniform
