...
output_folder = '/project/rrg-wperciva/tsfraser/LRGvoids/'   # /path/to/folder/ where output should be placed
# ========================================= #
...
tracer_file = '/project/rrg-wperciva/tsfraser/LRGMocks/CutSky/ELG/z0.800/cutsky_LRG_z0.800_AbacusSummit_base_c000_ph000.fits'     # /path/to/file with input data
...
z_low_cut = 0.5      # lower redshift cut (ignored if not survey)
z_high_cut = 1.1    # higher redshift cut (ignored if not survey)
...
random_file = '/project/rrg-wperciva/tsfraser/LRGMocks/CutSky/LRG/z0.800/cutsky_LRG_random_S1000_1X.fits'   # /path/to/file containing randoms data
...
z_min = 0.5        # minimum redshift extent of the data
z_max = 1.1        # maximum redshift extent of the data
